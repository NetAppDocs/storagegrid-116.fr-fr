...
* La taille maximale _recommandée_ pour une opération d'objet PUT unique est maintenant de 5 Gio (5,368,709,120 octets). Si vos objets sont supérieurs à 5 Gio, utilisez le téléchargement partitionné.
