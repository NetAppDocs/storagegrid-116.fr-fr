...
summary: 'Lorsqu"un client Swift émet une transaction PUT, une demande est faite pour créer un objet ou un conteneur. Ce message est émis par le serveur si la transaction a réussi.' 
---
= WPUT : PUT SWIFT
:allow-uri-read: 
:icons: font
...
Taille du contenu
 a| 
Taille de l'objet récupéré en octets. Les opérations sur les conteneurs n'incluent pas ce champ.
