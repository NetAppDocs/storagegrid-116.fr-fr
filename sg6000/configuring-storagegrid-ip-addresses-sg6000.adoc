...
Si vous souhaitez modifier la configuration de liaison, reportez-vous à la section xref:changing-link-configuration-of-sg6000-cn-controller.adoc[Instructions de modification de la configuration de liaison du contrôleur SG6000-CN].
