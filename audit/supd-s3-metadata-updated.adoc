...
ID de version
 a| 
ID de version de la version spécifique d'un objet dont les métadonnées ont été mises à jour. Les opérations sur les compartiments et objets dans les compartiments sans version n'incluent pas ce champ.
