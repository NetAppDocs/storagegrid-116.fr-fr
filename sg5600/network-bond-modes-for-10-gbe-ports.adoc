...
summary: Les ports réseau 10 GbE du contrôleur E5600SG prennent en charge le mode de liaison de port fixe ou le mode de liaison de port agrégé pour les connexions réseau Grid et réseau client. 
---
...
image::../media/e5600sg_fixed_port.gif[Ports utilisés pour le mode de liaison de port fixe]
...
image::../media/e5600sg_aggregate_port.gif[Ports utilisés pour le mode de liaison du port agrégé]
