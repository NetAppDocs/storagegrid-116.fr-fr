...
NOTE: Vous pouvez également configurer le système à l'aide du xref:../admin/index.adoc[Gestionnaire de grille] ou le xref:overview-of-installation-rest-apis.adoc[API d'installation].
