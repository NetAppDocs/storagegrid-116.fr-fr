...
xref:placing-appliance-into-maintenance-mode.adoc[Placez le contrôleur E5700SG en mode de maintenance].
...
+
Si vous avez modifié les paramètres VLAN, le sous-réseau de l'appliance a peut-être changé. Si vous devez modifier les adresses IP de l'appareil, suivez la xref:setting-ip-configuration-sg5700.adoc[Définissez la configuration IP] instructions.
