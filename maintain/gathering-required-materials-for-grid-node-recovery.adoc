...
Archive de l'installation de StorageGRID
 a| 
Si vous devez restaurer un nœud grid, vous devez ,Téléchargez les fichiers d'installation de StorageGRID pour votre plate-forme.
...
Pour connaître les versions actuelles prises en charge de votre plate-forme, reportez-vous à la section https://mysupport.netapp.com/matrix["Matrice d'interopérabilité NetApp"^].
