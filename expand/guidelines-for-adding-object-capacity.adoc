...
* Vous pouvez ajouter un ou deux tiroirs d'extension à chaque appliance SG6060 ou SG6060X. Chaque tiroir d'extension ajoute 16 volumes de stockage. Avec les deux tiroirs d'extension installés, les SG6060 et SG6060X peuvent prendre en charge un total de 48 volumes de stockage.
